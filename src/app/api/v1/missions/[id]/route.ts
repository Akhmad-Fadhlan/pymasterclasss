...
export async function PUT(
  ...
  try {
    ...
    // 3. Update mission details via service
    const result = await MissionService.updateMission(user.id, id, body);
...
export async function DELETE(
  ...
  try {
    ...
    // 3. Delete mission via service
    const result = await MissionService.deleteMission(user.id, id);
